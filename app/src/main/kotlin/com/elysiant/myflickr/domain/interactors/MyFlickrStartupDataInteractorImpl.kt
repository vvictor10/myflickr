...
@Singleton
class MyFlickrStartupDataInteractorImpl @Inject
constructor(private val lruCache: LruCache<Any, Any>, private val flickrApi: FlickrApi) :
    MyFlickrStartupDataInteractor {
